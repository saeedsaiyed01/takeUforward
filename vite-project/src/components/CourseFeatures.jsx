...
import coreSubjectsVideo from '../videos/coresubject.mp4';
import dsaVideo from '../videos/dsa1.mp4';
import lifetimeVideo from '../videos/live-time-validity.mp4';
import oopsVideo from '../videos/OOPs.mp4';
import roadmapVideo from '../videos/roadmap.mp4';
...
export default function CourseFeatures() {
  ...
  return (
    <div className="bg-[#0f0f0f] font-sans text-white py-10 px-6 md:px-20 min-h-screen"style={{ fontFamily: 'Geist, Geist Fallback, sans-serif' }}>
